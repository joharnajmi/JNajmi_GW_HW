...
file_to_output = os.path.join("paragraph_analysis_2.txt")
...
approximate_letter_count = sum(letter_counts) / float(len(letter_counts))
...
output = (
    ...
    f"Approximate Letter Count {approximate_letter_count:.1f}\n"
    f"Average Sentence Length: {avg_sentence_len:.1f}\n" )
    
# Save the results to analysis text file
f = open("paragraph_analysis_2.txt", "w")
f.write(output)
f.close()